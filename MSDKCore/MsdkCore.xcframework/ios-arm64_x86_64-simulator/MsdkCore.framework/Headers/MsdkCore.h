...
@property (class, readonly) MsdkCorePaymentMethodType *sbp __attribute__((swift_name("sbp")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AddInfo")))
@interface MsdkCoreAddInfo : MsdkCoreBase
- (instancetype)initWithQrData:(NSString * _Nullable)qrData lifetime:(NSString * _Nullable)lifetime __attribute__((swift_name("init(qrData:lifetime:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MsdkCoreAddInfoCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString * _Nullable lifetime __attribute__((swift_name("lifetime")));
@property (readonly) NSString * _Nullable qrData __attribute__((swift_name("qrData")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AddInfo.Companion")))
@interface MsdkCoreAddInfoCompanion : MsdkCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MsdkCoreAddInfoCompanion *shared __attribute__((swift_name("shared")));
- (id<MsdkCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface MsdkCoreDisplayData : MsdkCoreBase
- (instancetype)initWithAddInfo:(MsdkCoreAddInfo * _Nullable)addInfo __attribute__((swift_name("init(addInfo:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MsdkCoreDisplayDataCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) MsdkCoreAddInfo * _Nullable addInfo __attribute__((swift_name("addInfo")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DisplayData.Companion")))
@interface MsdkCoreDisplayDataCompanion : MsdkCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MsdkCoreDisplayDataCompanion *shared __attribute__((swift_name("shared")));
- (id<MsdkCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithId:(NSString * _Nullable)id serverStatusName:(NSString * _Nullable)serverStatusName status:(MsdkCorePaymentStatus * _Nullable)status purchase:(NSString * _Nullable)purchase date:(NSString * _Nullable)date method:(NSString * _Nullable)method paymentMethodType:(MsdkCorePaymentMethodType *)paymentMethodType methodName:(NSString * _Nullable)methodName description:(NSString * _Nullable)description account:(MsdkCoreAccount * _Nullable)account sum:(int64_t)sum sumReal:(MsdkCoreSumReal * _Nullable)sumReal acs:(MsdkCoreAcs * _Nullable)acs threeds2:(MsdkCoreThreeds2 * _Nullable)threeds2 type:(NSString * _Nullable)type token:(NSString * _Nullable)token clarificationFields:(NSArray<MsdkCoreClarificationField *> * _Nullable)clarificationFields completeFields:(NSArray<MsdkCoreCompleteField *> * _Nullable)completeFields currency:(NSString * _Nullable)currency cascadingWithRedirect:(MsdkCoreBoolean * _Nullable)cascadingWithRedirect projectName:(NSString * _Nullable)projectName recurringId:(MsdkCoreInt * _Nullable)recurringId redirectInfo:(NSString * _Nullable)redirectInfo consentData:(NSArray<MsdkCoreConsentData *> * _Nullable)consentData redirectInfoObject:(MsdkCoreRedirectInfo * _Nullable)redirectInfoObject paymentMassage:(NSString * _Nullable)paymentMassage displayData:(MsdkCoreDisplayData * _Nullable)displayData paymentFlow:(MsdkCorePaymentFlow * _Nullable)paymentFlow __attribute__((swift_name("init(id:serverStatusName:status:purchase:date:method:paymentMethodType:methodName:description:account:sum:sumReal:acs:threeds2:type:token:clarificationFields:completeFields:currency:cascadingWithRedirect:projectName:recurringId:redirectInfo:consentData:redirectInfoObject:paymentMassage:displayData:paymentFlow:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithSeen0:(int32_t)seen0 id:(NSString * _Nullable)id serverStatusName:(NSString * _Nullable)serverStatusName status:(MsdkCorePaymentStatus * _Nullable)status purchase:(NSString * _Nullable)purchase date:(NSString * _Nullable)date method:(NSString * _Nullable)method paymentMethodType:(MsdkCorePaymentMethodType * _Nullable)paymentMethodType methodName:(NSString * _Nullable)methodName description:(NSString * _Nullable)description account:(MsdkCoreAccount * _Nullable)account sum:(int64_t)sum sumReal:(MsdkCoreSumReal * _Nullable)sumReal acs:(MsdkCoreAcs * _Nullable)acs threeds2:(MsdkCoreThreeds2 * _Nullable)threeds2 type:(NSString * _Nullable)type token:(NSString * _Nullable)token clarificationFields:(NSArray<MsdkCoreClarificationField *> * _Nullable)clarificationFields completeFields:(NSArray<MsdkCoreCompleteField *> * _Nullable)completeFields currency:(NSString * _Nullable)currency cascadingWithRedirect:(MsdkCoreBoolean * _Nullable)cascadingWithRedirect projectName:(NSString * _Nullable)projectName recurringId:(MsdkCoreInt * _Nullable)recurringId redirectInfo:(NSString * _Nullable)redirectInfo consentData:(NSArray<MsdkCoreConsentData *> * _Nullable)consentData redirectInfoObject:(MsdkCoreRedirectInfo * _Nullable)redirectInfoObject paymentMassage:(NSString * _Nullable)paymentMassage displayData:(MsdkCoreDisplayData * _Nullable)displayData paymentFlow:(MsdkCorePaymentFlow * _Nullable)paymentFlow json:(NSString * _Nullable)json serializationConstructorMarker:(id _Nullable)serializationConstructorMarker __attribute__((swift_name("init(seen0:id:serverStatusName:status:purchase:date:method:paymentMethodType:methodName:description:account:sum:sumReal:acs:threeds2:type:token:clarificationFields:completeFields:currency:cascadingWithRedirect:projectName:recurringId:redirectInfo:consentData:redirectInfoObject:paymentMassage:displayData:paymentFlow:json:serializationConstructorMarker:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) MsdkCoreDisplayData * _Nullable displayData __attribute__((swift_name("displayData")));
...
@property (readonly) MsdkCoreSumReal * _Nullable sumReal __attribute__((swift_name("sumReal")));
...
@property (class, readonly) MsdkCorePaymentFlow *awaitingCustomer __attribute__((swift_name("awaitingCustomer")));
...
@property (class, readonly) MsdkCorePaymentStatus *awaitingCustomerAction __attribute__((swift_name("awaitingCustomerAction")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SumReal")))
@interface MsdkCoreSumReal : MsdkCoreBase
- (instancetype)initWithAmount:(MsdkCoreLong * _Nullable)amount currency:(NSString * _Nullable)currency __attribute__((swift_name("init(amount:currency:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MsdkCoreSumRealCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) MsdkCoreLong * _Nullable amount __attribute__((swift_name("amount")));
@property (readonly) NSString * _Nullable currency __attribute__((swift_name("currency")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SumReal.Companion")))
@interface MsdkCoreSumRealCompanion : MsdkCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MsdkCoreSumRealCompanion *shared __attribute__((swift_name("shared")));
- (id<MsdkCoreKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (void)onErrorCode:(MsdkCoreErrorCode *)code message:(NSString *)message __attribute__((swift_name("onError(code:message:)")));
- (void)onSbpQrDataReceivedQrData:(NSString *)qrData payment:(MsdkCorePayment *)payment __attribute__((swift_name("onSbpQrDataReceived(qrData:payment:)")));
...
__attribute__((swift_name("SbpRequest")))
@interface MsdkCoreSbpRequest : MsdkCorePayRequest
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SbpAuthRequest")))
@interface MsdkCoreSbpAuthRequest : MsdkCoreSbpRequest
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property NSArray<MsdkCoreCustomerFieldValue *> * _Nullable customerFields __attribute__((swift_name("customerFields")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SbpSaleRequest")))
@interface MsdkCoreSbpSaleRequest : MsdkCoreSbpRequest
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property NSArray<MsdkCoreCustomerFieldValue *> * _Nullable customerFields __attribute__((swift_name("customerFields")));
@property MsdkCoreRecipientInfo * _Nullable recipientInfo __attribute__((swift_name("recipientInfo")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SbpVerifyRequest")))
@interface MsdkCoreSbpVerifyRequest : MsdkCoreSbpRequest
- (instancetype)initWithVerificationCode:(NSString *)verificationCode __attribute__((swift_name("init(verificationCode:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
@property NSArray<MsdkCoreCustomerFieldValue *> * _Nullable customerFields __attribute__((swift_name("customerFields")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("IosBankInfo")))
@interface MsdkCoreIosBankInfo : MsdkCoreBase
- (instancetype)initWithScheme:(NSString *)scheme bankName:(NSString *)bankName isAvailable:(BOOL)isAvailable __attribute__((swift_name("init(scheme:bankName:isAvailable:)"))) __attribute__((objc_designated_initializer));
- (MsdkCoreIosBankInfo *)doCopyScheme:(NSString *)scheme bankName:(NSString *)bankName isAvailable:(BOOL)isAvailable __attribute__((swift_name("doCopy(scheme:bankName:isAvailable:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SbpHelper")))
@interface MsdkCoreSbpHelper : MsdkCoreBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) MsdkCoreSbpHelperCompanion *companion __attribute__((swift_name("companion")));

/**
 * Проверить, может ли устройство открыть deep link
 */
- (BOOL)canOpenBankAppDeepLink:(NSString *)deepLink __attribute__((swift_name("canOpenBankApp(deepLink:)")));

/**
 * Получить список доступных банковских схем
 */
- (NSArray<NSString *> *)getAvailableBankSchemes __attribute__((swift_name("getAvailableBankSchemes()")));

/**
 * Получить информацию о банке по схеме
 */
- (MsdkCoreIosBankInfo *)getBankInfoBySchemeScheme:(NSString *)scheme __attribute__((swift_name("getBankInfoByScheme(scheme:)")));

/**
 * Проверить доступность конкретного банка по схеме
 */
- (BOOL)isBankAppAvailableScheme:(NSString *)scheme __attribute__((swift_name("isBankAppAvailable(scheme:)")));

/**
 * Открыть банковское приложение по deep link
 */
- (void)openBankAppDeepLink:(NSString *)deepLink completion:(void (^ _Nullable)(MsdkCoreBoolean *))completion __attribute__((swift_name("openBankApp(deepLink:completion:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SbpHelper.Companion")))
@interface MsdkCoreSbpHelperCompanion : MsdkCoreBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MsdkCoreSbpHelperCompanion *shared __attribute__((swift_name("shared")));
@end
