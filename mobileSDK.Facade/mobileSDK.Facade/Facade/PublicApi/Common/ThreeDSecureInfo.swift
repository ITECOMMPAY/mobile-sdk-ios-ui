...
public class ThreeDSecureInfo: NSObject, Codable {
    ...
    @objc(threeDSecurePaymentInfo:threeDSecureCustomerInfo:)
    public init(_ threeDSecurePaymentInfo: ThreeDSecurePaymentInfo?, _ threeDSecureCustomerInfo: ThreeDSecureCustomerInfo?) {
...
public class ThreeDSecurePaymentInfo: NSObject, Codable  {
...
public class ThreeDSecureGiftCardInfo: NSObject, Codable  {
...
public class ThreeDSecureCustomerInfo: NSObject, Codable  {
...
public class ThreeDSecureAccountInfo: NSObject, Codable  {
...
public class ThreeDSecureShippingInfo: NSObject, Codable  {
...
public class ThreeDSecureMpiResultInfo: NSObject, Codable  {
