...
struct ThreeDSecureInfo: Codable {
    ...
    var sdkThreeDSecureInfo: ecommpaySDK_Dev.ThreeDSecureInfo {
        ecommpaySDK_Dev.ThreeDSecureInfo.init(
            threeDSecurePaymentInfo: paymentMerchantRisk?.payment.map({ payment in
                ecommpaySDK_Dev.ThreeDSecurePaymentInfo(
                    ...
                    giftCard: payment.giftCard.map({ giftCard in
                        ecommpaySDK_Dev.ThreeDSecureGiftCardInfo(
            ...
            threeDSecureCustomerInfo: ecommpaySDK_Dev.ThreeDSecureCustomerInfo(
                ...
                mpiResultInfo: customerMpiResult?.customer?.mpiResult.map({ mpiResult in
                    ecommpaySDK_Dev.ThreeDSecureMpiResultInfo(
