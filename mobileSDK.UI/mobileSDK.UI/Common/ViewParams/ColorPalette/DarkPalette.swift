...
struct DarkPalette: ColorPalette {
    ...
    init(brandPrimary: Color? = nil, brandSecondary: Color? = nil) {
        self.background = Color(hex: 0x121212)
        self.cardBackground = Color(hex: 0x212121)
        self.brandPrimary = brandPrimary ?? Color(hex: 0xCAB2FF)
        self.brandSecondary = brandSecondary ?? Color(hex: 0x4B007C)
        ...
        self.buttonArrow = Color(hex: 0x000000)
        self.buttonBackground = Color(hex: 0xCAB2FF)
        self.buttonCard = Color(hex: 0x000000)
        self.checkboxSelectedBackground = brandSecondary ?? Color(hex: 0x4B007C)
