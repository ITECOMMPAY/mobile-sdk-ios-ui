...
protocol DimensionScheme {
    /// Типичное расстояние от границ экрана до контента страницы, а также между логическими блоками
    ///  - default: 26
    var largeSpacing: CGFloat { get }
    /// Типичное расстояние от границ логического блока до элемента внутри
    ///  - default: 16
    var middleSpacing: CGFloat { get }
    /// Расстояние от границ блока деталей платежа до элементов внутри
    ///  - default: 20
    var paymentDetailsSpacing: CGFloat { get }
    /// Расстояние между элементами в списке либо связанными логически элементами
    ///  - default: 10
    var smallSpacing: CGFloat { get }
    /// Расстояние между названием атрибута в блоке деталей платежа и его описанием
    ///  - default: 6
    var paymentDetailsAttributeSpacing: CGFloat { get }
    /// Высота кнопки ApplePay
    ///  - default: 48
    var applePayButtonHeight: CGFloat { get }
    /// Высота кнопки платёжного метода
    ///  - default: 50
    var paymentMethodButtonHeight: CGFloat { get }
    /// Радиус скругления подложки
    ///  - default: 12
    var backgroundSheetCornerRadius: CGFloat { get }
    /// Радиус скругления копок
    ///  - default: 6
    var buttonCornerRadius: CGFloat { get }
    /// Наименьший радиус скругления
    ///  - default: 4
